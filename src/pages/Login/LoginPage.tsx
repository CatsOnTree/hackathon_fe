  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-2">AI Recruitment</h1>
        <p className="text-center text-gray-600 mb-8">Event Management Platform</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="space-y-3 text-sm text-gray-700 bg-gray-50 p-4 rounded">
            ...
            <div><strong>Panelist:</strong> panelist1@example.com / password123</div>
          </div>
        </div>
      </div>
    </div>
